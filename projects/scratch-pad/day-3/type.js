 ...
 * work?
 */
function isArray(value) { // check to see if there is a method you can already use?
 ...
 * with typeof.
 */
function isObject(value) { //  -> collection of key/value pairs
    // YOUR CODE BELOW HERE //{ a: 1 , b: 2 }
